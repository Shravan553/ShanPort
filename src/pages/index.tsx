...
export default function Home() {
  return (
    <>
      <NextSeo
        title="Shravan Gujaran | Software Developer"
        description="Explore the professional portfolio of Shravan Gujaran, a skilled Software Developer with 2 years of hands-on experience. Discover innovative projects, expertise in modern web technologies, and a passion for creating seamless user experiences."
